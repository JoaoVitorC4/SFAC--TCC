 ...
 * @author aquin
 */
public class Psq_EntradaVIEW extends javax.swing.JFrame {

    ResultSet rsentrada;
    EntradaVIEW objentrada = new EntradaVIEW();
    List<PerfilMODEL> listPerfil;
    PerfilCTR objperfil = new PerfilCTR();


    public Psq_EntradaVIEW() {
        initComponents();
     ...
     * WARNING: Do NOT modify this code. The entradaent of this method is always
    ...
    private void tblEntradaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblEntradaMouseClicked
        ...
        {
        objentrada.opcao = "Alterar";
        int linha = tblEntrada.getSelectedRow();
            
        objentrada.cod_entrada = (int) tblEntrada.getValueAt(linha, 0);
        objentrada.txtCod_entrada.setText((String)Integer.toString(objentrada.cod_entrada));
        objentrada.txtPessoa_entrada.setText((String)tblEntrada.getValueAt(linha, 1));
        objentrada.dataehora =  (String) tblEntrada.getValueAt(linha, 2);
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        ...
        EntradaVIEW objtelaentrada = new EntradaVIEW();
        
        objtelaentrada.opcao = "Inserir";
        
        objtelaentrada.setVisible(true);
        objtelaentrada.setLocationRelativeTo(null);
            this.dispose();
    ...
    (null, "Tem certeza que deseja excluir: " 
            +objentrada.txtCod_entrada.getText() + "?","AVISO", JOptionPane.YES_NO_OPTION,
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Psq_EntradaVIEW.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Psq_EntradaVIEW().setVisible(true);
            }
        });
    }
        ...
        public void pesquisarEntrada(){
            ...
            rsentrada = objentrada.PesquisarENTRADACTR(txtPesquisar.getText());
    ...
    public void preenche_conentrada(){
        
        String [] colunas = {"Código" ,"Date e Hora","Pessoa"};
        String [][] linhas = {};
        ...
        try {
            while (rsentrada.next())
            {
               ...
               regVetor.add(rsentrada.getInt("cod_entrada"));
                regVetor.add(rsentrada.getTimestamp("dataehora_entrada"));             
                regVetor.add(rsentrada.getString("pessoa_entrada"));          
                   
               dados.add(regVetor);
               tablemodel.addRow(regVetor);
            }  
            tblEntrada.setModel(tablemodel);
            
        } catch (SQLException ex) {
            Logger.getLogger(Psq_EntradaVIEW.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    {
        EntradaCTR objusu = new EntradaCTR();
        ...
        objusu.ExcluiEntradaCTR(objentrada.cod_entrada);
    }
